...
import { supabase, AdultScreening } from '../lib/supabase';

const AdultReport: React.FC = () => {
  const [searchParams] = useSearchParams();
  const { user } = useAuth();
  const screeningId = searchParams.get('screening_id');
  const [reportData, setReportData] = useState<AdultScreening | null>(null);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 medical-gradient-blue">
        ...
        <div className="absolute bottom-20 right-20 w-56 h-56 bg-white/5 rounded-full animate-pulse animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 w-40 h-40 bg-white/5 rounded-full animate-pulse animation-delay-4000"></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold">Adult Report</span>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-6 relative">
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-6 mb-6 border border-white/20">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Adult Screening Report</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-blue-50/50 rounded-xl border border-blue-100">
                ...
                <span className="font-mono text-lg font-bold text-blue-600">{reportData.screening_code}</span>
              </div>
              <div className="flex justify-between items-center p-4 bg-blue-50/50 rounded-xl border border-blue-100">
              ...
              <div className="flex justify-between items-center p-4 bg-blue-50/50 rounded-xl border border-blue-100">
                ...
                <span className="text-gray-600">{reportData.age} years</span>
              </div>
              <div className="flex justify-between items-center p-4 bg-blue-50/50 rounded-xl border border-blue-100">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-6 border border-white/20">
          ...
          <div className="space-y-4 mb-8">
            ...
            {[
              ...
              <div key={question.key} className="border border-blue-100 rounded-xl p-4 hover:bg-blue-50/50 transition-colors duration-300">
                <div className="flex justify-between items-start mb-2">
                  <span className="font-semibold text-blue-600 text-sm">{question.key}</span>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    reportData.responses[question.key] === 'yes' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                  }`}>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-6 border border-white/20">
          ...
          <div className="space-y-6">
            <div className="bg-blue-50/50 rounded-xl p-6 border border-blue-100">
              <h3 className="text-xl font-semibold text-blue-800 mb-4">💡 Evidence-Based Treatment Options</h3>
              <div className="space-y-4">
